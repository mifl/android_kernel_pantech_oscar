...
#endif
#if defined(CONFIG_PANTECH_ACPUPVS)
...
#if defined(CONFIG_PANTECH_ACPUPVS)
/* Added for store ACPU PVS value */
char acpupvs[30] = {0,};
/* Added for using proc file system */
struct proc_dir_entry *acpu_pvs_info;
#endif /* CONFIG_PANTECH_ACPUPVS */
